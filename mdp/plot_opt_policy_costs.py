...
def main(argv):
    ...
    if args.save:
        fig_breakdown.savefig(visuals_dir / "g_{}_opt_breakdown_{}_{}.png".format(args.version, paramsfile, v_str))
        fig_percents.savefig(visuals_dir / "g_{}_opt_percents_{}_{}.png".format(args.version, paramsfile, v_str))
        fig_total.savefig(visuals_dir / "g_{}_opt_total_{}_{}.png".format(args.version, paramsfile, v_str))
    plt.show()
